...
export const useCount = count.value
export const setCount = count.set
```
...
export const useText = text.value
export const setText = text.set
export const useResults = results.value
```
...
const useCount = count.value
const setCount = count.set
const useDouble = double.value
